...
import greet from "../../exercises/34-esm/greet.js";
import { greeter } from "../../exercises/34-esm/esm.js";
...
const greeterFilePath = path.resolve(
  __dirname,
  "../../exercises/34-esm/greet.js"
);

describe("ES Modules - Greet", () => {
  describe("Default Exports", () => {
    it('should have a new file named "greet.js" inside of "exercises/34-esm/". (NOTE that this is case sensitive)', () => {
